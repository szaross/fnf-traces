...
(C2,4,3) M3,4 := M3,4 - B2,4,3"
  ...
  defp get_word() do
    "A1,2 B1,1,2 C1,1,2 B1,2,2 C1,2,2 B1,3,2 C1,3,2 B1,4,2 C1,4,2 A1,3 B1,1,3 C1,1,3 B1,2,3 C1,2,3 B1,3,3 C1,3,3 B1,4,3 C1,4,3 A2,3 B2,2,3 C2,2,3 B2,3,3 C2,3,3 B2,4,3 C2,4,3"
  end
